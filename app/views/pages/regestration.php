...
<div class="bg-gray-50">
  ...
  <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img class="mx-auto h-24 w-auto" src="/ECOM/public/img/logo/X-COMM (2).png" alt="Workflow">
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        ...
        <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">
          Begin Your Style Story with Us.
        </a>
      </p>
    </div>
      ...
      <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
        ...
        <form method="POST" class="max-w-md mx-auto">
          ...
          <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="user" id="user" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-600 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-9 py-2.5 text-center dark:bg-black dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
      </div>
        </form>
